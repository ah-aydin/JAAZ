<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $query2 = "INSERT INTO Admins (admin_id, role) VALUES ((
                    SELECT user_id
                    FROM Users
                ...
                <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                    <div class="container-fluid">
                        <div class="navbar-wrapper">
                            ...
                            <div class="navbar-brand" href="javascript:;">Admin Sign Up (dis is for da homework, normally we would just create them manually)</div>
                        </div>
